...
<?php if ($model_rent) : ?>
    ...
    <div class="field">
        <?= $form->field($model_rent, 'rents_surname')
                ->input('text', [
                    'class' => 'field-input'])->label($model_rent->getAttributeLabel('rents_surname'), ['class' => 'field-label']) ?>
    </div>
    
    <div class="field">
        <?= $form->field($model_rent, 'rents_name')
                ->input('text', ['class' => 'field-input'])->label($model_rent->getAttributeLabel('rents_name'), ['class' => 'field-label']) ?>        
    </div>    
