...
<div class="dispatchers-default-index">
    ...
    <div class="col-md-8">
        <h3>Профиль</h3>
        <div class="col-md-6">
            <?= $form->field($specialist_info, 'employers_surname')
                    ->input('text', [
                        'placeHolder' => $specialist_info->getAttributeLabel('employers_surname')])
                    ->label() ?>

            <?= $form->field($specialist_info, 'employers_name')
                    ->input('text', [
                        'placeHolder' => $specialist_info->getAttributeLabel('employers_surname')])
                    ->label() ?>

            <?= $form->field($specialist_info, 'employers_second_name')
                    ->input('text', [
                        'placeHolder' => $specialist_info->getAttributeLabel('employers_surname')])
                    ->label() ?>
                    
            <?= $form->field($specialist_info, 'employers_birthday')
