    ...
    <div id="_list-res" class="row housing-stock">
            ...
            <div class="panel-group" id="accordion">
                ...
                <?php foreach ($houses_list as $key => $house) : ?>
                    <div class="panel panel-housing-stock">
                        ...
                        <div id="house<?= $house['houses_id'] ?>" class="panel-collapse collapse house_accordion <?= $active_item['value'] == $house['houses_id'] ? 'in' : '' ?>">
        ...
        <div class="col-md-2">
            ...
            <div id="characteristic_list">
                <?= $this->render('data/characteristics_house', ['characteristics' => $houses_list[$active_item['key']]['characteristic']]) ?>
            </div>
        </div>
        
        <div class="col-md-4">
            <div id="flats_list">
                <?= $this->render('data/view_flats', ['flats' => $houses_list[$active_item['key']]['flat']]) ?>
            </div>
        </div>
        ...
        <div class="col-md-2">
            ...
            <div id="files_list">
                <?= $this->render('data/view_upload_files', ['files' => $houses_list[$active_item['key']]['image']]) ?>
            </div>
        </div>
    </div>
