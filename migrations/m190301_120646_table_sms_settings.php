    ...
    public function safeUp() {
        ...
        $this->batchInsert('{{%sms_settings}}', 
                ...
                [
                    ...
                    ['new password', 'Пароль был успешно изменен. Пожалуйста, используйте ваш новый пароль для доступа в личный кабинет. Ваш новый пароль: '],
                    ...
                    ['sign in', 'Вход в личный кабинет Диспетчера. Код-подтверждения: '],
